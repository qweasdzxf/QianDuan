...
export default {
  ...
  methods: {
    ...
    submitForm(modelForm) {
      ...
      form.modelIsSuccessful = parseInt(this.modelForm.modelIsSuccessful);
      form.modelDescription = this.modelForm.description;
      this.formData.append('data', JSON.stringify(form));
      axios
