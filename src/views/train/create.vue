      ...
      <el-card shadow="hover">
        <el-form :model="form" ref="form" label-width="100px">
          ...
          <el-form-item label="算法">
            <el-col :span="10">
            <el-input v-model="form.train_task_algorithm_id"  placeholder="请输入算法ID" style="width: 300px"></el-input>
            </el-col>
            <el-col :span="2" :offset="1">数据集</el-col>
            <el-col :span="10">
               <el-input v-model="form.train_task_dataset_id"  placeholder="请输入数据集ID" style="width: 300px"></el-input>
            </el-col>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getParams() {
      ...
      axios.get('http://210.42.123.4:10001/algorithm/' + this.data.form.train_task_algorithm_id)
        .then(
          response => {
